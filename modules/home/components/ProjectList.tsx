    ...
    <div className="w-full mt-16">
      ...
      <div className="hidden lg:grid grid-cols-3 gap-4 max-w-6xl mx-auto">
        {projects.map((project) => (
          ...
          <Card
            key={project.id}
            className="group hover:shadow-xl transition-all duration-300 border-zinc-800/50 hover:border-amber-500/50 cursor-pointer bg-zinc-900/30 backdrop-blur-sm overflow-hidden"
          >
            <CardHeader className="pb-3">
              ...
              <CardTitle className="text-lg text-zinc-100 group-hover:text-amber-400 transition-colors line-clamp-1">
                {project.name}
              </CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <CarouselContent className="-ml-4">
            {projects.map((project) => (
              ...
              <CarouselItem key={project.id} className="pl-4 md:basis-1/2">
                <Card className="group hover:shadow-xl transition-all duration-300 border-zinc-800/50 hover:border-amber-500/50 cursor-pointer bg-zinc-900/30 backdrop-blur-sm">
                  <CardHeader className="pb-3">
                    <div className="flex items-start justify-between mb-3">
                      <div className="p-2.5 bg-amber-500/10 rounded-lg group-hover:bg-amber-500/20 transition-colors">
                        <FolderKanban className="w-5 h-5 text-amber-500" />
